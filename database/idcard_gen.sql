...
INSERT INTO `user` (`id`, `fullname`, `matric_number`, `gender`, `passport`, `level`, `password`, `request`, `status`) VALUES
(1, 'BOLA AHMED TINIBU', '123', 'Male', '../../passport/123.jpg', 400, '123', 1, 'approved');
